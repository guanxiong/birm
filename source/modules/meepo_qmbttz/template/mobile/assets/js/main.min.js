    ...
    var a = {
        ...
        initEvent: function() {
            if (!this.inited) {
                ...
                function() {
                    var b = $(this).data("sex");
                    b && (_czc.push(["_trackEvent", "选择性别", "m" == b ? "男": "女"]), a.sex = b, Config.$el.d_over_role.find("img").attr("src", "./source/modules/meepo_qmbttz/template/mobile/assets/img/" + b + ".png"), $(".role").addClass("role-" + b), Config.$el.d_sex.hide())
                }),
        ...
        gameOver: function() {
            ...
            this.animTimer = setInterval(function() {
                ...
                1e3), void clearInterval(b.animTimer)) : void Config.$el.bucket.css("background-image", "url(./source/modules/meepo_qmbttz/template/mobile/assets/assets/img/b" + a + ".png)")
            },
            200)
        },
        reset: function() {
            ...
            Config.$el.bucket.hide().css("background-image", "url(./source/modules/meepo_qmbttz/template/mobile/assets/assets/img/b1.png)"),
