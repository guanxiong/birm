...
(function( $ ){
  ...
  var methods = {
      ...
      update:function(options){
          ...
          var diy = document.getElementById('diybg').value;
          if(isfirst == 0){
              if(diy == ''){
                  //document.getElementById('cardbg').src = options.src;
                  //document.getElementById('hidbg').value = options.src;
                  $('#cardbg').attr('src',options.src);
                  $('#hidbg').val(options.src);
              }else if(diy.indexOf("./source/modules/icard/template/images/") >= 0){
                  //document.getElementById('diybg').value = options.src;
