...
class ActivityModuleSite extends WeModuleSite
{
    ...
    public function doWebActivityManger()
    {
        ...
        if ($operation == 'post') { // 添加
            ...
            if (checksubmit('submit')) {
                ...
                message('更新微活动成功！', create_url('site/module/activityManger', array(
                    'name' => 'activity',
                    'op' => 'display'
                )), 'success');
            }
            ...
            $list = pdo_fetchall("SELECT * FROM " . tablename($this->activitytalbe) . " WHERE weid = '{$_W['weid']}'  ORDER BY createtime DESC, id DESC LIMIT " . ($pindex - 1) * $psize . ',' . $psize);
            $total = pdo_fetchcolumn('SELECT COUNT(*) FROM ' . tablename($this->activitytalbe) . " WHERE weid = '{$_W['weid']}'");
    ...
    public function geturl($type = 0)
    {
        switch ($type) {
            case 0:
                $img_url = './source/modules/activity/images/ac_pic.jpg';
                break;
            case 1:
                $img_url = './source/modules/activity/images/ppt1.jpg';
                break;
            case 2:
                $img_url = './source/modules/activity/images/ppt2.jpg';
                break;
            case 3:
                $img_url = './source/modules/activity/images/ppt3.jpg';
                break;
        }
        return $img_url;
    }
    ...
    public function doWebDayManger()
    {
        ...
        if ($operation == 'display') { // 日程显示
            ...
            if (checksubmit('submit')) {
                ...
                message('更新活动日程成功！', create_url('site/module/dayManger', array(
                    'name' => 'activity',
                    'op' => 'display',
                    'aid' => $aid
                )), 'success');
    ...
    public function doWebnoteManger()
    {
        ...
        if ($operation == 'display') { // 日程显示
            ...
            if (checksubmit('submit')) {
                ...
                message('更新活动说明项成功！', create_url('site/module/noteManger', array(
                'name' => 'activity',
                'op' => 'display',
                'aid' => $aid
                )), 'success');
    ...
    public function  doWebTip(){
        ...
        if ($operation == 'display') { // 日程显示
            ...
            if (checksubmit('submit')) {
                ...
                message('更新邮件项成功！', create_url('site/module/tip', array(
                'name' => 'activity',
                'op' => 'display'
                )), 'success');
            }
    ...
    public function doWebGuestManger()
    {
        ...
        if ($operation == 'display') { // 日程显示
            ...
            if (checksubmit('submit')) {
                ...
                message('更新嘉宾成功！', create_url('site/module/guestManger', array(
                    'name' => 'activity',
                    'op' => 'display',
                    'aid' => $aid
                )), 'success');
